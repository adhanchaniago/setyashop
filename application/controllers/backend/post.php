...
class Post extends CI_Controller{
	...
	function simpan_post(){
		$config['upload_path'] = './assets/gambars/blog/'; //path folder
	    ...
	    if(!empty($_FILES['filefoto']['name'])){
	        if ($this->upload->do_upload('filefoto')){
	            ...
	            $config['source_image']='./assets/gambars/blog/'.$gbr['file_name'];
	            $config['create_thumb']= FALSE;
	            $config['maintain_ratio']= FALSE;
	            $config['quality']= '60%';
	            $config['width']= 379;
	            $config['height']= 271;
	            $config['new_image']= './assets/gambars/blog/'.$gbr['file_name'];

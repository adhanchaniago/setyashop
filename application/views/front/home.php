            ...
            <div id="wrapper" class="sixteen columns">
                ...
                <div id="banner">
                    ...
                    <div id="banner-slider" class="flexslider">
                        <ul class="slides">
                            <li>
                                <img src="<?php echo base_url().'theme/images/placeholders/foodpail.png'?>" alt="" />
                            </li>
                            <li>
                                <img src="<?php echo base_url().'theme/images/placeholders/lunchbox.png'?>" alt="" />
                            </li>
                            <li>
                                <img src="<?php echo base_url().'theme/images/placeholders/lunchbox_foodgrade.png'?>" alt="" />
                            </li>
                        </ul>
                    </div>
                ...
                <div id="content">
                    <div id="intro">
                        <h1><span>Welcome to Setya Shop</span></h1>
...
s1.async=true;
s1.src='https://embed.tawk.to/5c6112587cf662208c94f2fe/default';
s1.charset='UTF-8';

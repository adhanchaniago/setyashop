...
<!-- Meta tags -->
        <meta charset="utf-8">
        <meta name="description" content="Setya Shop Bantul Yogyakarta" />
                        ...
                        <div class="two-third column last">
                            <form style="margin-left:120px;" action="<?php echo base_url().'paket_tour/order'?>" method="post">
                                ...
                                <p>
                                    ...
                                    <input id="email" class="" placeholder="Contoh: hesendwiyatmiko@gmail.com" type="text" name="email" style="width:300px;" required/>
                                </p>
                                <h3 class="extra-margin top"><span class="left">Produk Info</span></h3>
                                <p>
                                    <label for="room-type" class="required label">Paket Produk:</label>
                                ...
                                <p>
                                    <label for="adultamt" class="required label">Qty:</label>
                                    <input type="text" id="qty" name="qty" value="1" class="spinner" />
                                </p>

                    ...
                    <div id="blog" class="container section">
                        <div id="blog-content" class="two-third column end">
                            <div id="post-content" class="blog-item">
                                <img width="700" height="400" src="<?php echo base_url().'assets/gambars/produk/'.$n['gambar'];?>" alt="">
                                ...
                                <div id="about-author">
                                    <h4><a href="<?php echo base_url().'paket_tour/pesan_paket/'.$n['idpaket'];?>" class="small gray button">Pesan Sekarang</a></h2>
                        ...
                        <div id="sidebar-content" class="one-third column last">
                            ...
                            <div class="sidebar-item">
                                ...
                                ?>
                                    <li>
                                        <a href="<?php echo base_url().'paket_tour/detail_paket/'.$idpaket;?>"><img width="50" height="50" src="<?php echo base_url().'assets/gambars/produk/'.$gbr;?>" alt="" /><span><?php echo $nmpaket;?></span></a>
                                    </li>
                                <?php
                                    }
                                ?>

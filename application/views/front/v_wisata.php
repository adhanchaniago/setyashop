                    ...
                    <div id="blog" class="container section">
                        ...
                        ?>
                            <div class="blog-item">
                                <div class="hover">
                                    ...
                                    </div> <img width="560" height="150" src="<?php echo base_url().'assets/gambars/layanan/'.$gbr;?>" alt="" /> </a>
                                </div>
                        ...
                        <div id="sidebar-content" class="one-third column last">
                            <div class="sidebar-item">
                                <h3 class="nobg">Cari Produk anda disini</h3>
                            ...
                            <div class="sidebar-item">
                                <h3 class="nobg">Layanan Lainnya</h3>
                                ...
                                ?>
                                    <li>
                                        <a href="<?php echo base_url().'wisata_post/detail_wisata/'.$idberita;?>"><img width="50" height="50" src="<?php echo base_url().'assets/gambars/layanan/'.$gbr;?>" alt="" /><?php echo $judul;?></a>
                                        <span></span>
                                    </li>
                                <?php
                                    }

                    ...
                    <div class="container section">
                        <div id="gallery" class="four-columns">
                            ...
                            <div class="beach photo-item hover">
                                <a href="<?php echo base_url().'assets/gambars/gallery/'.$gbr_galeri;?>" class="image-box">
                                <div class="photo">
                                    <span class="text"><span class="anchor"></span></span>
                                </div> <img src="<?php echo base_url().'assets/gambars/gallery/'.$gbr_galeri;?>" title="<?php echo $jdl_galeri;?>" /> </a>
                            </div>
                            <?php
                                }
                            ?>

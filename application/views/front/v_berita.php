                    ...
                    <div id="blog" class="container section">
                        ...
                        ?>
                            <div class="blog-item">
                                <div class="hover">
                                    ...
                                    </div> <img width="560" height="150" src="<?php echo base_url().'assets/gambars/blog/'.$gbr;?>" alt="" /> </a>
                                </div>
                        ...
                        <div id="sidebar-content" class="one-third column last">
                            ...
                            <div class="sidebar-item">
                                ...
                                ?>
                                    <li>
                                        <a href="<?php echo base_url().'berita_post/detail_berita/'.$idberita;?>"><img width="50" height="50" src="<?php echo base_url().'assets/gambars/blog/'.$gbr;?>" alt="" /><?php echo $judul;?></a>

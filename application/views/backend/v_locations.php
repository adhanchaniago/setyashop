...
<head>
  ...
  <title>Setya Shop | Edit Posting</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
		...
		<form action="<?php echo base_url().'backend/setting/update_locations'?>" method="post" enctype="multipart/form-data">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <textarea name="google_maps" placeholder="Google Maps Frame" class="form-control" rows="4" value="about" id="about"><?php echo $site['google_maps']; ?></textarea>
        </div>
    </div>
    
    <div class="col-md-6" style="padding-bottom: 20px;">
    	<label>Example:</label><br>
        <img src="<?php echo base_url('assets/images/frame_maps.png/') ?>" style="max-width:400px; height:auto;">
    </div>
    <div class="col-md-12">
        <center><iframe src="<?php echo $site['google_maps'];?>" width="850" height="350" frameborder="0" style="border:0" allowfullscreen></iframe></center>
    </div>

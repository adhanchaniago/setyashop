...
<head>
  ...
  <title>Setya Shop | Orders List</title>
        ...
        <div class="col-xs-12">
          ...
          ?>
            <tr>
                ...
                <td style="text-align: right;vertical-align: middle;"><?php echo 'Rp '.number_format($sub_discount); ?></td>
    ...
    foreach($data->result_array() as $a):
        ...
        <div id="modalEdit<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-9">
                    <input name="qty" class="form-control" min="1" type="number" value="<?php echo $qty;?>" style="width:280px;" required>
                </div>
            </div>

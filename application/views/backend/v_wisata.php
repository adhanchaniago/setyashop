...
<head>
  ...
  <title>Setya Shop | Wisata List</title>
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url().'backend/paket_tour'?>"><i class="fa fa-gift"></i> Paket Produk</a></li>
            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tbody>
                    ...
                    ?>
                <tr>
                  <td><img src="<?php echo base_url().'assets/gambars/layanan/'.$gambar;?>" style="width:90px;"></td>
    ...
    <form class="form-horizontal" method="post" action="<?php echo base_url().'backend/wisata/simpan_wisata'?>" enctype="multipart/form-data">
        <div class="modal-body">
            ...
            <div class="form-group">
                <label class="control-label col-xs-2" >Layanan</label>
                <div class="col-xs-8">
                    <input name="nama_wisata" class="form-control" type="text" placeholder="Nama Layanan..." required>
                </div>
            </div>
...
<div class="modal fade" id="ModalUpdate<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
    ...
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
        <h3 class="modal-title" id="myModalLabel">Update Layanan</h3>
    </div>
    <form class="form-horizontal" method="post" action="<?php echo base_url().'backend/wisata/update_wisata'?>" enctype="multipart/form-data">
        <div class="modal-body">
            ...
            <div class="form-group">
                <label class="control-label col-xs-2" >Layanan</label>
                <div class="col-xs-8">
                    <input name="nama_wisata" value="<?php echo $nama_wisata;?>" class="form-control" type="text" placeholder="Nama Layanan..." required>
                </div>
            </div>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">       
							       <input type="hidden" name="kode" value="<?php echo $id;?>"/> 
                          <p>Apakah Anda yakin mau menghapus layanan <b><?php echo $nama_wisata;?></b> ?</p>

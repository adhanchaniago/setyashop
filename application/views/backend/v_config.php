...
<head>
  ...
  <title>Setya Shop | Edit Config</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
		...
		<form action="<?php echo base_url().'backend/setting/update_config'?>" method="post" enctype="multipart/form-data">
          ...
          <div class="row">
			...
			<label>Website Name</label>
			  ...
			  <div class="form-group">
				<label>Short Website Name </label>
				<input type="text" name="singkatanweb" placeholder="Nama Pendek Website" value="<?php echo $site['singkatanweb'] ?>" required class="form-control">
				</div>
				<div class="form-group">
				<label>Email</label>
      ...
      <div class="row">
        ...
        <textarea name="about" placeholder="Tentang Website" class="form-control" value="about" id="ckeditor"><?php echo $site['about']; ?></textarea>

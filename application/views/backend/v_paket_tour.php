...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url().'backend/setting/config'?>"><i class="fa fa-puzzle-piece"></i> General Settings</a></li>
            <li><a href="<?php echo base_url().'backend/setting/locations'?>"><i class="fa fa-tag"></i> Locations</a></li>
		  </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li>
          <a href="<?php echo base_url().'backend/wisata'?>">
            <i class="fa fa-map-signs"></i> <span>Layanan</span>
            <span class="pull-right-container">
              <small class="label pull-right"></small>
            </span>
          </a>
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?php echo base_url().'backend/paket_tour'?>"><i class="fa fa-gift"></i> Paket Produk</a></li>
            ...
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tr>
                    ...
                    <th style="text-align: right;">Harga Discount</th>
                  ...
                  <?php
                    $no=0;
                        foreach($data->result_array() as $a):
                            ...
                            $harga=$a['harga'];
                            $harga_discount=$a['harga_discount'];
                            $kategori_id=$a['kategori_id'];
                    ?>
                <tr>
                  <td><img src="<?php echo base_url().'assets/gambars/produk/'.$gambar;?>" style="width:90px;"></td>
                  <td><?php echo $nama_paket;?></td>
                  <td style="text-align: right;"><?php echo 'Rp '.number_format($harga);?></td>
                  <td style="text-align: right;"><?php echo 'Rp '.number_format($harga_discount);?></td>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="http://gentasolusi.com">Genta Informatika</a>.</strong> All rights reserved.
  </footer>
    ...
    <form class="form-horizontal" method="post" action="<?php echo base_url().'backend/paket_tour/simpan_paket'?>" enctype="multipart/form-data">
        <div class="modal-body">
            ...
            <div class="form-group">
                <label class="control-label col-xs-2" >Paroduk </label>
                <div class="col-xs-8">
                    <input name="nama_paket" class="form-control" type="text" placeholder="Nama Produk" required>
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="control-label col-xs-2" >Harga Discount</label>
                <div class="col-xs-8">
                    <input name="harga_discount" class="form-control" type="text" placeholder="Harga Discount" required>
                </div>
            </div>
    ...
    <form class="form-horizontal" method="post" action="<?php echo base_url().'backend/paket_tour/update_paket'?>" enctype="multipart/form-data">
        <div class="modal-body">
            ...
            <div class="form-group">
                <label class="control-label col-xs-2" >Harga Discount</label>
                <div class="col-xs-8">
                    <input name="harga_discount" value="<?php echo $harga_discount;?>" class="form-control" type="text" placeholder="Harga Discount" required>
                </div>
            </div>
